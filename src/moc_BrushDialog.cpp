...
struct qt_meta_stringdata_CLASSBrushDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSBrushDialogENDCLASS = QtMocHelpers::stringData(
    "BrushDialog",
    "previewUpdated",
    "",
    "cv::Mat",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBrushDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject BrushDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBrushDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBrushDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSBrushDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void BrushDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onBrushTypeChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        case 5: _t->onEraserToggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        ...
        {
            using _t = void (BrushDialog::*)(const cv::Mat & );
            if (_t _q_method = &BrushDialog::previewUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *BrushDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSBrushDialogENDCLASS.stringdata0))
...
// SIGNAL 0
void BrushDialog::previewUpdated(const cv::Mat & _t1)
{
