...
Write-Host " Creating Working MOC File" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan

Write-Host "`nGenerating MOC file..." -ForegroundColor Yellow

# Create the MOC file content directly
$mocContent = @"
/****************************************************************************
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "`nAccess via: Color ? [Feature Name]" -ForegroundColor Yellow
    Write-Host "`nRun the application: Press F5 in Visual Studio" -ForegroundColor Cyan
